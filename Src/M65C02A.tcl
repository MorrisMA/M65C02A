# 
# Project automation script for M65C02A 
# 
...
proc add_source_files {} {
   ...
   xfile add "Src/BRAM_SP_mn.v"
   xfile add "Src/DSPFmnCE/DPSFnmCE.v"
   xfile add "Src/M65C02A.bmm"
   xfile add "Src/M65C02A.ucf"
   xfile add "Src/M65C02A.v"
   xfile add "Src/M65C02A_ALU.v"
   xfile add "Src/M65C02A_ALUv2.v"
   xfile add "Src/M65C02A_Add.v"
   xfile add "Src/M65C02A_AddrGen.v"
   xfile add "Src/M65C02A_Core.v"
   xfile add "Src/M65C02A_ForthVM.v"
   xfile add "Src/M65C02A_IntHndlr.v"
   xfile add "Src/M65C02A_LST.v"
   xfile add "Src/M65C02A_LU.v"
   xfile add "Src/M65C02A_MMU.v"
   xfile add "Src/M65C02A_MPC.v"
   xfile add "Src/M65C02A_PSW.v"
   xfile add "Src/M65C02A_RegStk.v"
   xfile add "Src/M65C02A_RegStkV2.v"
   xfile add "Src/M65C02A_SPIxIF.v"
   xfile add "Src/M65C02A_SU.v"
   xfile add "Src/M65C02A_StkPtr.v"
   xfile add "Src/M65C02A_StkPtrV2.v"
   xfile add "Src/M65C02A_WrSel.v"
   xfile add "Src/SPIxIF/SPIxIF.v"
   xfile add "Src/UART/UART.v"
   xfile add "Src/UART/UART_BRG.v"
   xfile add "Src/UART/UART_INT.v"
   xfile add "Src/UART/UART_RTO.v"
   xfile add "Src/UART/UART_RXSM.v"
   xfile add "Src/UART/UART_TXSM.v"
   xfile add "Src/UART/tb_UART_RXSM.v"
   xfile add "Src/UART/tb_UART_TXSM.v"
   xfile add "Src/fedet.v"
   xfile add "Src/redet.v"
   xfile add "Src/tb_M65C02A.v"

   # Set the Top Module as well...
   project set top "M65C02A"
...
proc set_process_props {} {
   ...
   project set "SmartGuide Filename" "M65C02A_guide.ncd"
   ...
   project set "Other Bitgen Command Line Options" "-bd Pgms/M65C02A_MEM.mem" -process "Generate Programming File"
   ...
   project set "Other Ngdbuild Command Line Options" "-bm Src/M65C02A.bmm" -process "Translate"
