...
proc add_source_files {} {
   ...
   xfile add "Src/M65C02A_Work/tb_M65C02A_Add.v"
   xfile add "Src/M65C02_ALU.v"
   xfile add "Src/M65C02_ALUv2.v"
   xfile add "Src/M65C02_ALUv2_Def.txt"
   ...
   project set top "M65C02_CoreV2_Top"
...
proc set_process_props {} {
   ...
   project set "SmartGuide Filename" "M65C02_CoreV2_Top_guide.ncd"
