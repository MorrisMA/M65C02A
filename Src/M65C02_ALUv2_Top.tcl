...
# If you load this file (using the Tcl command: source M65C02_ALUv2_Top.tcl, then you can
...
set myScript "M65C02_ALUv2_Top.tcl"
...
proc add_source_files {} {
   ...
   xfile add "A6502/A6502_Top.v"
   xfile add "A6502/ALU.v"
   xfile add "A6502/cpu.v"
   xfile add "Src/65C02_ft.txt"
   xfile add "Src/ChoChi_SRAM_IF.v"
   xfile add "Src/ClkGen.xaw"
   xfile add "Src/M65C02.v"
   xfile add "Src/M65C02_ALU.v"
   xfile add "Src/M65C02_ALUv2.v"
   xfile add "Src/M65C02_ALUv2_Top.ucf"
   xfile add "Src/M65C02_ALUv2_Top.v"
   xfile add "Src/M65C02_Add.v"
   xfile add "Src/M65C02_AddrGen.v"
   xfile add "Src/M65C02_AddrGenV2.v"
   xfile add "Src/M65C02_BCD.v"
   xfile add "Src/M65C02_BIN.v"
   xfile add "Src/M65C02_ClkGen.v"
   xfile add "Src/M65C02_Core.v"
   xfile add "Src/M65C02_CoreV2.v"
   xfile add "Src/M65C02_CoreV2_Top.ucf"
   xfile add "Src/M65C02_CoreV2_Top.v"
   xfile add "Src/M65C02_Decoder_ROM.txt"
   xfile add "Src/M65C02_Hist_File.txt"
   xfile add "Src/M65C02_IntHndlr.v"
   xfile add "Src/M65C02_LST.v"
   xfile add "Src/M65C02_LU.v"
   xfile add "Src/M65C02_MPCv4.v"
   xfile add "Src/M65C02_MPCv5.v"
   xfile add "Src/M65C02_Mnemonics.txt"
   xfile add "Src/M65C02_PSW.v"
   xfile add "Src/M65C02_PSWv2.v"
   xfile add "Src/M65C02_RAM.txt"
   xfile add "Src/M65C02_RAM.v"
   xfile add "Src/M65C02_SU.v"
   xfile add "Src/M65C02_SV_Output.txt"
   xfile add "Src/M65C02_StkPtr.v"
   xfile add "Src/M65C02_Tst3.txt"
   xfile add "Src/M65C02_WrSel.v"
   xfile add "Src/M65C02_uPgm_V3.txt"
   xfile add "Src/M65C02_uPgm_V3a.txt"
   xfile add "Src/SRAM_IF_Tst.v"
   xfile add "Src/SRAM_StbGen.v"
   xfile add "Src/fedet.v"
   xfile add "Src/tb_ChoChi_SRAM_IF.v"
   xfile add "Src/tb_M65C02.v"
   xfile add "Src/tb_M65C02_ALU.v"
   xfile add "Src/tb_M65C02_ALUv2.v"
   ...
   project set top "M65C02_ALUv2_Top"
...
proc set_process_props {} {
   ...
   project set "SmartGuide Filename" "M65C02_ALUv2_Top_guide.ncd"
   ...
   project set "Starting Placer Cost Table (1-100)" "3" -process "Map"
